...
items = importlib.import_module('katas.kyu6.Shop Inventory Manager.solution').items
update_quality = importlib.import_module('katas.kyu6.Shop Inventory Manager.solution').update_quality
